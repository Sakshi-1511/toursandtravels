  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ac43"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-1b93" data-image-width="5184" data-image-height="3456">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h1 class="u-align-center-xs u-text u-text-1">Registered Users</h1>
      </div>
    </section>
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 72px;">
                ...
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-3">Email</th>
                 ...
                 <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-4">Username</th>
               <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-4">Password</th>
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-5">Address</th>
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-6">Phone </th>
                ...
                <th class="u-border-1 u-border-black u-palette-1-base u-table-cell u-table-cell-6">Action </th>
                        ...
                        <tr style="height: 75px;">
                                ...
                                <td class="u-border-1 u-border-grey-30 u-table-cell"><?php  echo $row['Username']; ?></td>
                                <td class="u-border-1 u-border-grey-30 u-table-cell"><?php  echo $row['Password']; ?></td>
                                ...
                                <td class="u-border-1 u-border-grey-30 u-table-cell" >
                                    <form action="code.php" method="post">
                                        <input type="hidden" name="delete_Phone" value="<?php echo $row['Phone']; ?>">
