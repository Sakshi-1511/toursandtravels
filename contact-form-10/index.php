...
<html lang="en">
  <head>
	...
	<body>
	<section class="ftco-section img bg-hero" style="background-image: url(../images/wall5.jpg);">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Difficult Roads Often Lead To Beautiful Destination!!</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-11">
					<div class="wrapper">
						<div class="row no-gutters justify-content-between">
							...
							<div class="col-lg-5">
								<div >
									<h3 class="mb-4" style="color:white"><b>Enquire Here</b></h3>
				            ...
				            Your message was sent, thank you!
									...
									<form method="POST"  action="enquiry.php">
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="date" class="form-control" name="date" id="date" placeholder="Travel date" required>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="number" class="form-control" name="adults" id="adults" placeholder="Adults" required>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<input type="number" class="form-control" name="kids" id="kids" placeholder="Kids">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
